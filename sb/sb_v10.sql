...
ALTER TABLE registry.branches
ADD COLUMN isa BOOLEAN DEFAULT true;

ALTER TABLE registry.branches_v
ADD COLUMN isa BOOLEAN DEFAULT true;

ALTER TABLE registry.devices
ADD COLUMN isa BOOLEAN DEFAULT true;

ALTER TABLE registry.devices_v
ADD COLUMN isa BOOLEAN DEFAULT true;
...
CREATE TYPE registry.sb_msgs AS ENUM (
  ...
  'INVALID_VPA',
  'INVALID_DEVICE',
  'DEVICE_ALREADY_BOUNDED',
  'VPA_ALREADY_BOUNDED',
  'DEVICE_DEACTIVATED_BANK',
  'DEVICE_DEACTIVATED_BRANCH',
  'DEVICE_DEACTIVATED_MERCHANT',
  'BANK_VPA_UNMATCHED_BID',-----allocated banks bid and vpa bid unmatched
  'INVALID_BANK',
  'BANK_ALREADY_ALLOCATED',
  'DEVICE_DEACTIVATED_VPA',
...
UPDATE registry.sb SET vid = null
EXPLAIN ANALYZE
