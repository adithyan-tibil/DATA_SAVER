...
def main():
    ...
    input_folder_path = "/home/aditya/adithyan/pyspark_POC/sample3_xml/plain_text"  # Change this to your input folder path
    output_folder_path = "/home/aditya/adithyan/pyspark_POC/sample3_xml/input"  # Change this to your output folder path
